...
using Abp.Hangfire;
using Abp.Owin;
using SimpleEmployeeManagement.Api.Controllers;
using SimpleEmployeeManagement.Web;
using Hangfire;
...
namespace SimpleEmployeeManagement.Web
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            //ENABLE TO USE HANGFIRE dashboard (Requires enabling Hangfire in SimpleEmployeeManagementWebModule)
